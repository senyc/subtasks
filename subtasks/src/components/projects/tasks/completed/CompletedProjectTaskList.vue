<template>
  <fwb-table>
    ...
    <fwb-table-body>
      <CompletedProjectTaskRow :project-id="projectId" @toggle-checked="toggleChecked" :checkedTasks="checkedTasks"
...
import useCompletedTasks from '@actions/completedTasks'
import CompletedProjectTaskRow from './CompletedProjectTaskRow.vue';
...
const { data: tasks } = useCompletedTasks(props.projectId)
